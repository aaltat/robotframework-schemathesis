...
- No force for msgpack
  ([`1632dab`](https://github.com/aaltat/robotframework-schemathesis/commit/1632daba3f06b291ea2403356dceff70c18caa07))

- Update deps
  ([`0a0f8e8`](https://github.com/aaltat/robotframework-schemathesis/commit/0a0f8e8c83dffc9800af184c5f37680fd84cbc0b))

- Update msgpack>=1.2.1 for security vuln
  ([`8abf275`](https://github.com/aaltat/robotframework-schemathesis/commit/8abf2758920cd137896bcd54fcaf577e252e902a))

### Chores

- Update dev deps
  ([`8ca72f3`](https://github.com/aaltat/robotframework-schemathesis/commit/8ca72f31f6f0462254d40a949e644715d555cdbc))

- **deps**: Bump idna from 3.11 to 3.15
  ([`c675f74`](https://github.com/aaltat/robotframework-schemathesis/commit/c675f74b7b715f1e411dda2ddaba891bf5dac167))

- **deps**: Bump msgpack from 1.1.2 to 1.2.1
  ([`02f54f8`](https://github.com/aaltat/robotframework-schemathesis/commit/02f54f8883c6c2d91b4b3a874f8745867f7af4b3))

- **deps**: Bump pydantic-settings from 2.12.0 to 2.14.2
  ([`a99da6a`](https://github.com/aaltat/robotframework-schemathesis/commit/a99da6a83074531ebca1380d29ec9dcac55f9bfe))

- **deps**: Bump python-multipart from 0.0.27 to 0.0.31
  ([`242a387`](https://github.com/aaltat/robotframework-schemathesis/commit/242a387ae3b77ff0c457e75629b7f131d0c0f858))

- **deps**: Bump robotframework-pythonlibcore from 4.5.0 to 4.6.0
  ([`cd7ae56`](https://github.com/aaltat/robotframework-schemathesis/commit/cd7ae566daff7d153830764c3a86d033a7c9435d))

- **deps**: Bump schemathesis from 4.18.0 to 4.18.3
  ([`0516593`](https://github.com/aaltat/robotframework-schemathesis/commit/05165932e6dfea76307ada1b0191555857f501f7))

- **deps**: Bump schemathesis from 4.18.3 to 4.18.4
  ([`a750cdd`](https://github.com/aaltat/robotframework-schemathesis/commit/a750cdd6a7486a054e596df9cbd2071ef2b6721a))

- **deps**: Bump schemathesis from 4.18.4 to 4.18.5
  ([`bd606cb`](https://github.com/aaltat/robotframework-schemathesis/commit/bd606cbbe1b1c088d5e0f0206bf765c1b0176573))

- **deps**: Bump schemathesis from 4.18.5 to 4.19.0
  ([`04901c5`](https://github.com/aaltat/robotframework-schemathesis/commit/04901c5b96f21fec4ed7399f1f938d5b41ba24d0))

- **deps**: Bump schemathesis from 4.19.0 to 4.20.0
  ([`df89930`](https://github.com/aaltat/robotframework-schemathesis/commit/df89930d6a8b6d938da19b8498e62e7eeb43e145))

- **deps**: Bump schemathesis from 4.20.0 to 4.20.1
  ([`c221daa`](https://github.com/aaltat/robotframework-schemathesis/commit/c221daae0a3d2f92ffd1b913f5a77ad6cd9e8b6c))

- **deps**: Bump schemathesis from 4.20.1 to 4.20.2
  ([`d6fe34c`](https://github.com/aaltat/robotframework-schemathesis/commit/d6fe34c1839014ac8840ba2662aab3eb1b20aa13))

- **deps**: Bump schemathesis from 4.20.2 to 4.20.3
  ([`d55d215`](https://github.com/aaltat/robotframework-schemathesis/commit/d55d215d6f89f1dc758e38a6c024daa1a59c8a84))

- **deps**: Bump schemathesis from 4.20.3 to 4.21.0
  ([`162d5a3`](https://github.com/aaltat/robotframework-schemathesis/commit/162d5a3bbeb51ab043416adc034c85842b5bf040))

- **deps**: Bump schemathesis from 4.21.0 to 4.21.1
  ([`888d470`](https://github.com/aaltat/robotframework-schemathesis/commit/888d4702e7d3f76932735b7f87d8383dd6ccd171))

- **deps**: Bump schemathesis from 4.21.1 to 4.21.4
  ([`50c6537`](https://github.com/aaltat/robotframework-schemathesis/commit/50c6537871bf2699347a783449edffadf7d7d672))

- **deps**: Bump schemathesis from 4.21.4 to 4.21.5
  ([`cd1932d`](https://github.com/aaltat/robotframework-schemathesis/commit/cd1932dbdbd6744dc0590500e5eeab51e838e17e))

- **deps**: Bump schemathesis from 4.21.5 to 4.21.7
  ([`88540c2`](https://github.com/aaltat/robotframework-schemathesis/commit/88540c226eb3658861bc0e9082c94a1c3acb2312))

- **deps**: Bump schemathesis from 4.21.7 to 4.21.8
  ([`2c84302`](https://github.com/aaltat/robotframework-schemathesis/commit/2c843029aa85a07007031e1309d2d8506b8bf7e7))

- **deps**: Bump schemathesis from 4.21.8 to 4.21.9
  ([`2d08163`](https://github.com/aaltat/robotframework-schemathesis/commit/2d081631f268dec4155614a8f4b0d0d56fad29f2))

- **deps**: Bump starlette from 0.49.3 to 1.0.1
  ([`3bf0c21`](https://github.com/aaltat/robotframework-schemathesis/commit/3bf0c21eaf4a311d0a411bd97d6ee733d5bdf652))

- **deps**: Bump starlette from 1.0.1 to 1.3.1
  ([`18cf79d`](https://github.com/aaltat/robotframework-schemathesis/commit/18cf79d68af234c8205e2f6300f3ddd70e87cb43))

- **deps-dev**: Bump coverage from 7.13.5 to 7.14.0
  ([`fd4b322`](https://github.com/aaltat/robotframework-schemathesis/commit/fd4b322524819b9b7a28ed4960059dd00f8f6cd1))

- **deps-dev**: Bump coverage from 7.14.0 to 7.14.1
  ([`7b5e9ef`](https://github.com/aaltat/robotframework-schemathesis/commit/7b5e9ef88d73bd0520aad1c914e3118844821076))

- **deps-dev**: Bump mypy from 2.0.0 to 2.1.0
  ([`1c334d3`](https://github.com/aaltat/robotframework-schemathesis/commit/1c334d3e5c702552d15ba60cdf9991e204f2ab37))

- **deps-dev**: Bump pytest from 9.0.3 to 9.1.0
  ([`848f34d`](https://github.com/aaltat/robotframework-schemathesis/commit/848f34d44148026a3b05d7c9e2af2f8b6dd17d4e))

- **deps-dev**: Bump pytest from 9.1.0 to 9.1.1
  ([`e684afb`](https://github.com/aaltat/robotframework-schemathesis/commit/e684afb5d17b346d4421dc90f0d836dbf501eb3e))

- **deps-dev**: Bump requests from 2.33.1 to 2.34.0
  ([`173f897`](https://github.com/aaltat/robotframework-schemathesis/commit/173f8976d2231aabeba94c45554235b4cda1b7e7))

- **deps-dev**: Bump requests from 2.34.0 to 2.34.1
  ([`9b46fff`](https://github.com/aaltat/robotframework-schemathesis/commit/9b46fff615745ef8d778efc47d46f8c9fd3c7d7c))

- **deps-dev**: Bump requests from 2.34.1 to 2.34.2
  ([`f118f54`](https://github.com/aaltat/robotframework-schemathesis/commit/f118f54456c6abb296d0b0693873196c38c38179))

- **deps-dev**: Bump robotframework-robocop from 8.2.10 to 8.2.11
  ([`47aa377`](https://github.com/aaltat/robotframework-schemathesis/commit/47aa37729f7bc86a4e00f0691a9aafca5902846b))

- **deps-dev**: Bump robotframework-robocop from 8.2.11 to 8.3.1
  ([`d4f6e7f`](https://github.com/aaltat/robotframework-schemathesis/commit/d4f6e7fd9337a063c942db10e17b547e92f583cf))

- **deps-dev**: Bump robotframework-robocop from 8.2.7 to 8.2.8
  ([`5141097`](https://github.com/aaltat/robotframework-schemathesis/commit/514109731c143db326a2cd054237579ff5d0f6cd))

- **deps-dev**: Bump robotframework-robocop from 8.2.8 to 8.2.9
  ([`3e078fb`](https://github.com/aaltat/robotframework-schemathesis/commit/3e078fb1d94372588280e3e8e44b4383860a43fe))

- **deps-dev**: Bump robotframework-robocop from 8.2.9 to 8.2.10
  ([`380625f`](https://github.com/aaltat/robotframework-schemathesis/commit/380625f82721d06c7d5725de9288b3273e4e1b62))

- **deps-dev**: Bump robotframework-robocop from 8.3.1 to 8.3.2
  ([`3e34de1`](https://github.com/aaltat/robotframework-schemathesis/commit/3e34de1f1f42f63096a4e529c039ecb5e142fd1c))

- **deps-dev**: Bump ruff from 0.15.12 to 0.15.13
  ([`0014a01`](https://github.com/aaltat/robotframework-schemathesis/commit/0014a0181bc40bf354dd578e65b63cbd98107058))

- **deps-dev**: Bump ruff from 0.15.13 to 0.15.14
  ([`966a1dc`](https://github.com/aaltat/robotframework-schemathesis/commit/966a1dc46667dd854a5f9a40fab53b3ebe68adad))

- **deps-dev**: Bump ruff from 0.15.14 to 0.15.15
  ([`696a1a8`](https://github.com/aaltat/robotframework-schemathesis/commit/696a1a814148cc9f861ac5bc43622a8f2df87b33))

- **deps-dev**: Bump ruff from 0.15.15 to 0.15.16
  ([`b88a832`](https://github.com/aaltat/robotframework-schemathesis/commit/b88a832e8d282a1985c0cc42ee4e3eaebc90479f))

- **deps-dev**: Bump ruff from 0.15.16 to 0.15.17
  ([`012e54b`](https://github.com/aaltat/robotframework-schemathesis/commit/012e54b83857f50409cf87e94ba4901da0589a20))

- **deps-dev**: Bump ruff from 0.15.17 to 0.15.18
  ([`11adc5c`](https://github.com/aaltat/robotframework-schemathesis/commit/11adc5c1138271275289fb739d06e0074016c899))

- **deps-dev**: Bump types-requests
  ([`cf45867`](https://github.com/aaltat/robotframework-schemathesis/commit/cf458675e1f6ab1fca88c47bb797a96dccb7c6e1))

- **deps-dev**: Bump types-requests
  ([`5a48108`](https://github.com/aaltat/robotframework-schemathesis/commit/5a48108536907d606e7b9b871137435d6dcd1e19))

### Features

- Declare pabot support
  ([`1b8a1a6`](https://github.com/aaltat/robotframework-schemathesis/commit/1b8a1a64eb15e2550e42069974f9331adc348b50))
...
- Raise minumun required schemathesis to 4.17.0
  ([`16cf771`](https://github.com/aaltat/robotframework-schemathesis/commit/16cf77148c487bc730815637bca2d315fe5622b1))

### Chores

- Update dev deps
  ([`ea6c233`](https://github.com/aaltat/robotframework-schemathesis/commit/ea6c23348f75faac138fe6ff3c22d6c421872414))

- **deps**: Bump EndBug/add-and-commit from 9 to 10
  ([`ed5396f`](https://github.com/aaltat/robotframework-schemathesis/commit/ed5396f9823c3fb0f3d2c29ab69a2bdc38c9ebd5))

- **deps**: Bump pygments from 2.19.2 to 2.20.0
  ([`9c63400`](https://github.com/aaltat/robotframework-schemathesis/commit/9c63400a081537be60f4214fc608f73742817324))

- **deps**: Bump python-dotenv from 1.2.1 to 1.2.2
  ([`23d1dcf`](https://github.com/aaltat/robotframework-schemathesis/commit/23d1dcfbb567bf2accb1968ef569dd167d8992fd))

- **deps**: Bump python-multipart from 0.0.22 to 0.0.26
  ([`1b6e20f`](https://github.com/aaltat/robotframework-schemathesis/commit/1b6e20f24b6a33e186df963bccf32fee45e0fa90))

- **deps**: Bump robotframework from 7.4.1 to 7.4.2
  ([`3449e2b`](https://github.com/aaltat/robotframework-schemathesis/commit/3449e2bda76072345a13316ea98cc0dfcb4d5d0d))

- **deps**: Bump schemathesis from 4.12.0 to 4.12.1
  ([`42b9860`](https://github.com/aaltat/robotframework-schemathesis/commit/42b9860312fa288d78b2fe887d11582e067f1816))

- **deps**: Bump schemathesis from 4.12.1 to 4.12.2
  ([`537aa69`](https://github.com/aaltat/robotframework-schemathesis/commit/537aa6925e2682d8fc3b186c376e89a25e6d378c))

- **deps**: Bump schemathesis from 4.12.2 to 4.13.0
  ([`aeab315`](https://github.com/aaltat/robotframework-schemathesis/commit/aeab315f4744876c35f6580ea8863ec1f10c066c))

- **deps**: Bump schemathesis from 4.13.0 to 4.14.1
  ([`571431a`](https://github.com/aaltat/robotframework-schemathesis/commit/571431a44f2a111ca2b66f47875f44f2ae2bbe69))

- **deps**: Bump schemathesis from 4.14.1 to 4.14.2
  ([`a7dad6a`](https://github.com/aaltat/robotframework-schemathesis/commit/a7dad6a01fd139124860e1ce35ecbf87aedbfe06))

- **deps**: Bump schemathesis from 4.14.2 to 4.14.3
  ([`eeaa57d`](https://github.com/aaltat/robotframework-schemathesis/commit/eeaa57d4ee33340f605163b934d66b90af66b421))

- **deps**: Bump schemathesis from 4.14.3 to 4.15.0
  ([`494d8fe`](https://github.com/aaltat/robotframework-schemathesis/commit/494d8feda10e2a3900d8653c9976ba39f19d6837))

- **deps**: Bump schemathesis from 4.15.0 to 4.15.1
  ([`4d694c1`](https://github.com/aaltat/robotframework-schemathesis/commit/4d694c1f30938121b6f529b4a81245f03f4f2fdb))

- **deps**: Bump schemathesis from 4.15.1 to 4.15.2
  ([`a448d68`](https://github.com/aaltat/robotframework-schemathesis/commit/a448d68d8580cf853ee86c6bcc399b35e62f0526))

- **deps**: Bump schemathesis from 4.15.2 to 4.16.1
  ([`ec57ab5`](https://github.com/aaltat/robotframework-schemathesis/commit/ec57ab54ed9ab0e7da2d35166d7d603ec09d28bb))

- **deps**: Bump schemathesis from 4.16.1 to 4.17.0
  ([`d9156f7`](https://github.com/aaltat/robotframework-schemathesis/commit/d9156f71b34f621452811aa647f5de409957db5c))

- **deps-dev**: Bump coverage from 7.13.4 to 7.13.5
  ([`b5033b8`](https://github.com/aaltat/robotframework-schemathesis/commit/b5033b8f6854810a17d6a018065ee4b9215d41ef))

- **deps-dev**: Bump invoke from 2.2.1 to 3.0.1
  ([`25a6488`](https://github.com/aaltat/robotframework-schemathesis/commit/25a6488f982ce95466e5fc0e15fec45dcc63a59b))

- **deps-dev**: Bump invoke from 3.0.1 to 3.0.3
  ([`7c9b8ad`](https://github.com/aaltat/robotframework-schemathesis/commit/7c9b8ad88845e59dc2d74687da362199f2aa4089))

- **deps-dev**: Bump mypy from 1.19.1 to 1.20.0
  ([`1c48377`](https://github.com/aaltat/robotframework-schemathesis/commit/1c483770c879f0bfa9d7583048f60dd2519a3369))

- **deps-dev**: Bump mypy from 1.20.0 to 1.20.1
  ([`2b0eafc`](https://github.com/aaltat/robotframework-schemathesis/commit/2b0eafc871480f020771cea71fa54b610079f8c2))

- **deps-dev**: Bump mypy from 1.20.1 to 1.20.2
  ([`3568680`](https://github.com/aaltat/robotframework-schemathesis/commit/3568680988c3b9502485315e41ed39d2c658f679))

- **deps-dev**: Bump pytest from 9.0.2 to 9.0.3
  ([`e123046`](https://github.com/aaltat/robotframework-schemathesis/commit/e12304651aab3277144ec167a6bd19d859edc028))

- **deps-dev**: Bump requests from 2.32.5 to 2.33.0
  ([`29d6ec5`](https://github.com/aaltat/robotframework-schemathesis/commit/29d6ec56044f9de95029e5a8f7bfdee513faced0))

- **deps-dev**: Bump requests from 2.33.0 to 2.33.1
  ([`21c6907`](https://github.com/aaltat/robotframework-schemathesis/commit/21c6907e679a274e74f785d3d2c13512e9df485b))

- **deps-dev**: Bump robotframework-robocop from 8.2.2 to 8.2.3
  ([`285802d`](https://github.com/aaltat/robotframework-schemathesis/commit/285802dd91f51182027cd24b90c5fd216407053e))

- **deps-dev**: Bump robotframework-robocop from 8.2.3 to 8.2.4
  ([`fc21335`](https://github.com/aaltat/robotframework-schemathesis/commit/fc213353307f9fe1d2130c4d2c613a515b43f32f))

- **deps-dev**: Bump robotframework-robocop from 8.2.4 to 8.2.5
  ([`874f7ac`](https://github.com/aaltat/robotframework-schemathesis/commit/874f7ac887306fec5ace744a371e1def94619759))

- **deps-dev**: Bump robotframework-robocop from 8.2.5 to 8.2.6
  ([`3a95446`](https://github.com/aaltat/robotframework-schemathesis/commit/3a95446a3eb3c17f8dd35b577709ea517956cac3))

- **deps-dev**: Bump robotframework-robocop from 8.2.6 to 8.2.7
  ([`309e67f`](https://github.com/aaltat/robotframework-schemathesis/commit/309e67f7e3b65e3136b6503f44bc1f4db72ea903))

- **deps-dev**: Bump ruff from 0.15.10 to 0.15.11
  ([`a3a6356`](https://github.com/aaltat/robotframework-schemathesis/commit/a3a63564029925a06e053a2a3217bc2cdb62c886))

- **deps-dev**: Bump ruff from 0.15.11 to 0.15.12
  ([`cde9c70`](https://github.com/aaltat/robotframework-schemathesis/commit/cde9c70346dc4bbf2bf9bc5d34b4f1b476298ad0))

- **deps-dev**: Bump ruff from 0.15.6 to 0.15.7
  ([`cd3c7ba`](https://github.com/aaltat/robotframework-schemathesis/commit/cd3c7baf5be2d102c5d2bf955ee3905d7a7b9c3d))

- **deps-dev**: Bump ruff from 0.15.7 to 0.15.8
  ([`e8fac66`](https://github.com/aaltat/robotframework-schemathesis/commit/e8fac66090565dc1fd3e1b4475931557016bd30c))

- **deps-dev**: Bump ruff from 0.15.8 to 0.15.9
  ([`f8275a4`](https://github.com/aaltat/robotframework-schemathesis/commit/f8275a445f203f3a2aa80a9a9c4bbf5ec6cdeda4))

- **deps-dev**: Bump ruff from 0.15.9 to 0.15.10
  ([`a1a83d0`](https://github.com/aaltat/robotframework-schemathesis/commit/a1a83d046b35a6468d969033b7b6d10908a22f8e))

- **deps-dev**: Bump types-requests
  ([`3f82181`](https://github.com/aaltat/robotframework-schemathesis/commit/3f8218119db0ab09916cef5bd500f5223b2869a8))

- **deps-dev**: Bump types-requests
  ([`a0dba03`](https://github.com/aaltat/robotframework-schemathesis/commit/a0dba03dfc46b7d5dcf0eb0c0fe9eb6db2a62fbc))

- **deps-dev**: Bump types-requests
  ([`3ceae75`](https://github.com/aaltat/robotframework-schemathesis/commit/3ceae755edc27ddc3195d1d3d56d3d904665366b))

- **deps-dev**: Bump types-requests
  ([`278e442`](https://github.com/aaltat/robotframework-schemathesis/commit/278e4426028aa7638a2acbb96c57c7c77c64ddd1))

- **deps-dev**: Bump types-requests
  ([`467cfbf`](https://github.com/aaltat/robotframework-schemathesis/commit/467cfbfc705098ace08e92e9ad3625869ffa2f26))
...
- **deps**: Bump actions/upload-artifact from 6 to 7
  ([`d0d88f3`](https://github.com/aaltat/robotframework-schemathesis/commit/d0d88f3697a6682054491656df10d3e570db9dcd))

- **deps**: Bump schemathesis from 4.10.1 to 4.10.2
  ([`ed84940`](https://github.com/aaltat/robotframework-schemathesis/commit/ed84940b3afefad77ee311e5b9e3092069ad5728))

- **deps**: Bump schemathesis from 4.10.2 to 4.11.0
  ([`15ab551`](https://github.com/aaltat/robotframework-schemathesis/commit/15ab551d594b6170effbfdfe88b23e2bc4add5c2))

- **deps**: Bump schemathesis from 4.11.0 to 4.11.1
  ([`9b1c62c`](https://github.com/aaltat/robotframework-schemathesis/commit/9b1c62cf4200b5ca39ff6f6430cd89cd14df6ab2))

- **deps**: Bump schemathesis from 4.11.1 to 4.11.2
  ([`24e4469`](https://github.com/aaltat/robotframework-schemathesis/commit/24e4469d1b254f84260a57b40db994da19dd81ab))

- **deps**: Bump schemathesis from 4.11.2 to 4.12.0
  ([`8dc90db`](https://github.com/aaltat/robotframework-schemathesis/commit/8dc90db9b539a326b876056583806f81457dbc49))

- **deps**: Bump schemathesis from 4.9.5 to 4.10.1
  ([`ea11c23`](https://github.com/aaltat/robotframework-schemathesis/commit/ea11c234812b363aacaf79b05360b3c5248f72b7))

- **deps**: Bump werkzeug from 3.1.5 to 3.1.6
  ([`015d0f9`](https://github.com/aaltat/robotframework-schemathesis/commit/015d0f949dc27e69c50f7ffe39e91fde2213c10e))

- **deps-dev**: Bump coverage from 7.13.3 to 7.13.4
  ([`0508ee5`](https://github.com/aaltat/robotframework-schemathesis/commit/0508ee5ffdeb0930188970f39b089dd523c8fcd1))

- **deps-dev**: Bump robotframework-robocop from 7.2.0 to 8.0.0
  ([`f193b97`](https://github.com/aaltat/robotframework-schemathesis/commit/f193b97029a01112b39b7fb0094938a556f5e8c6))

- **deps-dev**: Bump robotframework-robocop from 8.0.0 to 8.1.1
  ([`3cec2f4`](https://github.com/aaltat/robotframework-schemathesis/commit/3cec2f4235862504a84bf4a863721c4f1dafbb2b))

- **deps-dev**: Bump robotframework-robocop from 8.1.1 to 8.2.0
  ([`e57b2fd`](https://github.com/aaltat/robotframework-schemathesis/commit/e57b2fd6eededb973b2cce4748fc259b890b6f81))

- **deps-dev**: Bump robotframework-robocop from 8.2.0 to 8.2.2
  ([`6297197`](https://github.com/aaltat/robotframework-schemathesis/commit/629719732acb058d69e79ad8c7bbb393805463f2))

- **deps-dev**: Bump ruff from 0.15.0 to 0.15.1
  ([`92e6a08`](https://github.com/aaltat/robotframework-schemathesis/commit/92e6a0853ea4065b82953d91424867dbd2cbf0b8))

- **deps-dev**: Bump ruff from 0.15.1 to 0.15.2
  ([`737fd81`](https://github.com/aaltat/robotframework-schemathesis/commit/737fd8192d8d867f93e3b3439b86c4fc0502b7d8))

- **deps-dev**: Bump ruff from 0.15.2 to 0.15.4
  ([`f2e321e`](https://github.com/aaltat/robotframework-schemathesis/commit/f2e321ec36c9cefdeb4d0b5c64b9dedbac3920cf))

- **deps-dev**: Bump ruff from 0.15.4 to 0.15.5
  ([`cf4a545`](https://github.com/aaltat/robotframework-schemathesis/commit/cf4a545a481d2368e65606e9bcaa0d6cdf72d7da))

- **deps-dev**: Bump ruff from 0.15.5 to 0.15.6
  ([`de13fea`](https://github.com/aaltat/robotframework-schemathesis/commit/de13fea8dc9e37c0be47822b1edc9039627bd904))

### Features

- Ass As cURL keywords
  ([`c1400ed`](https://github.com/aaltat/robotframework-schemathesis/commit/c1400edc8bc8c4905b366e5d58622817fd004a43))
...
- Use latest schemathesis 4.6.8
  ([`7abf58e`](https://github.com/aaltat/robotframework-schemathesis/commit/7abf58e2354b51cabbe7be5cc2368ad622e3a7fe))

### Chores

- Update dev deps
  ([`c647726`](https://github.com/aaltat/robotframework-schemathesis/commit/c64772605c0d99a0a1e14bb31fa2bbfebaef8bca))

- **deps**: Bump actions/checkout from 5 to 6
  ([`76b820c`](https://github.com/aaltat/robotframework-schemathesis/commit/76b820c86cfd36d70ef55ed4f39f3c2c3d3926e4))

- **deps**: Bump mypy from 1.18.2 to 1.19.0
  ([`6ebc13a`](https://github.com/aaltat/robotframework-schemathesis/commit/6ebc13a07d8480d5599c62fe66ca356bd0d4d555))

- **deps**: Bump robotframework-robocop from 6.10.0 to 6.10.1
  ([`c65698f`](https://github.com/aaltat/robotframework-schemathesis/commit/c65698ffd5476b7fbab0345f6ef3b56faab2fa0c))

- **deps**: Bump robotframework-robocop from 6.10.1 to 6.11.0
  ([`34aea47`](https://github.com/aaltat/robotframework-schemathesis/commit/34aea47670cf58f602419d930ec22ce3c4b72c09))

- **deps**: Bump robotframework-robocop from 6.11.0 to 6.12.0
  ([`cf88e5a`](https://github.com/aaltat/robotframework-schemathesis/commit/cf88e5a95f7ece920eab1a7272a22a4f76bd8073))

- **deps**: Bump robotframework-robocop from 6.12.0 to 6.13.0
  ([`bf1c786`](https://github.com/aaltat/robotframework-schemathesis/commit/bf1c7860fddaf306ca5cde7253dd426477cb0a16))

- **deps**: Bump ruff from 0.14.4 to 0.14.5
  ([`5bc4dc0`](https://github.com/aaltat/robotframework-schemathesis/commit/5bc4dc04e02c6409048969222269b471a8c0dd82))

- **deps**: Bump ruff from 0.14.5 to 0.14.6
  ([`a70446d`](https://github.com/aaltat/robotframework-schemathesis/commit/a70446d9b34572a31d96489d8d9f0da613cfc21e))

- **deps**: Bump ruff from 0.14.6 to 0.14.7
  ([`ba41084`](https://github.com/aaltat/robotframework-schemathesis/commit/ba410848d977f2723c7cdea8c8f4df103e29b36c))

- **deps**: Bump ruff from 0.14.7 to 0.14.8
  ([`f9438eb`](https://github.com/aaltat/robotframework-schemathesis/commit/f9438eb6e03b0650b804fef78984a64f1d496df8))

- **deps**: Bump schemathesis from 4.5.1 to 4.5.3
  ([`154c868`](https://github.com/aaltat/robotframework-schemathesis/commit/154c868430218dc0c728e2b3d3e54b8e0f6bdc28))

- **deps**: Bump schemathesis from 4.5.3 to 4.5.4
  ([`68b0f8a`](https://github.com/aaltat/robotframework-schemathesis/commit/68b0f8a6d81aba6d6226d6c21bdb45b4e657f59d))

- **deps**: Bump schemathesis from 4.5.4 to 4.6.1
  ([`f1da50d`](https://github.com/aaltat/robotframework-schemathesis/commit/f1da50d728baedd69bef54ab67bf15bf28b5ff51))

- **deps**: Bump schemathesis from 4.6.1 to 4.6.2
  ([`c7de967`](https://github.com/aaltat/robotframework-schemathesis/commit/c7de967d3fc9e1e99c0959910718290495ed629f))

- **deps**: Bump schemathesis from 4.6.2 to 4.6.3
  ([`944fd56`](https://github.com/aaltat/robotframework-schemathesis/commit/944fd563393c146ddc49fd0b6f8840724b0b5810))

- **deps**: Bump schemathesis from 4.6.3 to 4.6.4
  ([`322cecc`](https://github.com/aaltat/robotframework-schemathesis/commit/322cecc23ed65f620f9dc58195f0ffe49ca4d0dd))

- **deps**: Bump schemathesis from 4.6.4 to 4.6.6
  ([`c4e8e63`](https://github.com/aaltat/robotframework-schemathesis/commit/c4e8e637d97d8354fc7e91d60dcb7671737fdc42))

- **deps**: Bump schemathesis from 4.6.6 to 4.6.8
  ([`e0c9f75`](https://github.com/aaltat/robotframework-schemathesis/commit/e0c9f756f72fe249c631fd75a90eee38b6bddd8d))
...
- **deps**: Bump ruff from 0.14.2 to 0.14.3
  ([`46db1d1`](https://github.com/aaltat/robotframework-schemathesis/commit/46db1d19c906d1b11cce9dc2ac45706de3ad829b))
...
- **deps**: Bump ruff from 0.14.1 to 0.14.2
  ([`2ea805e`](https://github.com/aaltat/robotframework-schemathesis/commit/2ea805e489f3d97961c4ed9016113d8fd3443d14))
...
- **deps**: Bump schemathesis from 4.3.3 to 4.3.4
  ([`5d8994a`](https://github.com/aaltat/robotframework-schemathesis/commit/5d8994a738b3d49b41e4ef413f042e1eb12d072c))
...
- **deps**: Bump ruff from 0.14.0 to 0.14.1
  ([`3081801`](https://github.com/aaltat/robotframework-schemathesis/commit/3081801a0de294072543c5ee93fba69982450b6b))

- **deps**: Bump schemathesis from 4.3.2 to 4.3.3
  ([`d93d6e8`](https://github.com/aaltat/robotframework-schemathesis/commit/d93d6e87c433fca19ba702799d9fc2e17aec3dfc))
...
- **deps**: Bump schemathesis from 4.3.0 to 4.3.2
  ([`48dcf91`](https://github.com/aaltat/robotframework-schemathesis/commit/48dcf913bedf0082864e67afb33c006f9b562410))
...
- **deps**: Bump schemathesis from 4.2.0 to 4.2.1
  ([`7e73279`](https://github.com/aaltat/robotframework-schemathesis/commit/7e7327925a2a056f785ff621461b509d8b44422b))
...
- **deps**: Bump schemathesis from 4.1.4 to 4.2.0
  ([`5f059d0`](https://github.com/aaltat/robotframework-schemathesis/commit/5f059d04849a20b8dea6f63011b40fa6a2523848))
...
- **deps**: Bump ruff from 0.13.2 to 0.13.3
  ([`bee0705`](https://github.com/aaltat/robotframework-schemathesis/commit/bee0705b84c34fadbe3b13c3333f91e3eb954298))
...
- **deps**: Bump ruff from 0.13.1 to 0.13.2
  ([`708bce1`](https://github.com/aaltat/robotframework-schemathesis/commit/708bce1cb685060f3eb1d795e8ebc903db927939))
...
- **deps**: Bump ruff from 0.13.0 to 0.13.1
  ([`b6353e4`](https://github.com/aaltat/robotframework-schemathesis/commit/b6353e452776fe0704b84349e2371c2404a4cf8d))
...
- **deps**: Bump mypy from 1.17.1 to 1.18.1
  ([`4bb98e1`](https://github.com/aaltat/robotframework-schemathesis/commit/4bb98e1ed605484648b310cb12f7ae25cdd442d8))
...
- **deps**: Bump ruff from 0.12.12 to 0.13.0
  ([`56af257`](https://github.com/aaltat/robotframework-schemathesis/commit/56af2570dc19186a4d5acc6e8ab7eac5c02341dd))
...
- **deps**: Bump schemathesis from 4.1.3 to 4.1.4
  ([`446a0f4`](https://github.com/aaltat/robotframework-schemathesis/commit/446a0f4068b1cae6dcee8135723607a865b6a6bd))
...
- **deps**: Bump ruff from 0.12.10 to 0.12.11
  ([`6e0bd36`](https://github.com/aaltat/robotframework-schemathesis/commit/6e0bd364274b6c2249a4e91f19d6767b9200eb56))

- **deps**: Bump schemathesis from 4.1.2 to 4.1.3
  ([`2ee9d59`](https://github.com/aaltat/robotframework-schemathesis/commit/2ee9d59795cdfd729754e200e9065cf4028ca9e7))
...
- **deps**: Bump schemathesis from 4.1.0 to 4.1.2
  ([`ade705a`](https://github.com/aaltat/robotframework-schemathesis/commit/ade705a50f64ebd39989c14c6f5645e897242616))
...
- **deps**: Bump ruff from 0.12.9 to 0.12.10
  ([`a9face5`](https://github.com/aaltat/robotframework-schemathesis/commit/a9face501b0b2089e97da99836d66172b8eac04b))
...
- **deps**: Bump schemathesis from 4.0.26 to 4.1.0
  ([`b22eaa9`](https://github.com/aaltat/robotframework-schemathesis/commit/b22eaa9581ee00975f840c689e6af02c9f42a87d))
...
- **deps**: Bump ruff from 0.12.8 to 0.12.9
  ([`59def4a`](https://github.com/aaltat/robotframework-schemathesis/commit/59def4af3ba13d5811033f3e6ac9759bfeb9fc42))
...
- **deps**: Bump schemathesis from 4.0.25 to 4.0.26
  ([`a3812c3`](https://github.com/aaltat/robotframework-schemathesis/commit/a3812c3bdc6dbf719c3a3937bb1fbf994723fff2))
